        ...
        <div className="space-y-6">
          <Card>
            ...
            <div className="space-y-4">
              <div className="relative">
                ...
                <div className="space-y-4">
                  <div className="relative">
                    ...
                    <select value={origin} onChange={e => setOrigin(e.target.value)} className="w-full bg-gray-100 dark:bg-[#0a0c14] border border-gray-300 dark:border-white/10 rounded-lg px-3 py-2 text-gray-900 dark:text-white text-sm focus:outline-none focus:border-cyan-500 ml-2 max-w-[calc(100%-8px)]">
                      {Object.keys(locs).map(k => <option key={k} value={k}>{k}</option>)}
                    </select>
                  </div>
                  <div className="relative">
                    <div className="absolute left-3 top-9 w-2.5 h-2.5 rounded-full border-2 border-emerald-500 bg-[#0a0c14] z-10"></div>
                    <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1 ml-8">Destination</label>
                    <select value={destination} onChange={e => setDestination(e.target.value)} className="w-full bg-gray-100 dark:bg-[#0a0c14] border border-gray-300 dark:border-white/10 rounded-lg px-3 py-2 text-gray-900 dark:text-white text-sm focus:outline-none focus:border-cyan-500 ml-2 max-w-[calc(100%-8px)]">
                      {Object.keys(locs).map(k => <option key={k} value={k}>{k}</option>)}
                    </select>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3 pt-4 border-t border-gray-300 dark:border-white/5">
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Cargo Profile</label>
                  <select className="w-full bg-gray-100 dark:bg-[#0a0c14] border border-gray-300 dark:border-white/10 rounded-lg px-3 py-2 text-gray-900 dark:text-white text-sm focus:outline-none focus:border-cyan-500">
          ...
          {analyzed && (
            <Card className="border border-cyan-500/30 bg-cyan-950/10 relative overflow-hidden">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3 relative z-10">
                <div className="bg-[#0a0c14] border border-white/5 p-3 rounded-lg">
                  <div className="text-xs text-gray-500 font-bold uppercase mb-1">Est. Distance</div>
                  <div className="text-xl font-bold text-white">{distance} km</div>
                </div>
                <div className="bg-[#0a0c14] border border-white/5 p-3 rounded-lg">
                  <div className="text-xs text-gray-500 font-bold uppercase mb-1">Travel Time</div>
                  <div className="text-xl font-bold text-white">{eta}h {delay}m</div>
                </div>
              </div>
            </Card>
          )}
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card noPadding className="h-[400px] relative overflow-hidden group">
            ...
            <div className="absolute top-4 left-4 right-4 flex justify-between z-[1000] pointer-events-none">
              <div className="bg-[#0a0c14]/90 border border-white/10 backdrop-blur px-4 py-2 rounded-lg pointer-events-auto">
                <div className="text-xs text-gray-400 font-bold uppercase tracking-wider flex items-center gap-2">
                  <Monitor className="w-3.5 h-3.5" /> SAT-LINK ACTIVE
                </div>
              </div>
            </div>
          </Card>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Card className="p-4 flex flex-col justify-between">
                ...
                <div>
                  ...
                  <div className="text-xl font-bold text-white">{risk}%</div>
                </div>
              </Card>
              <Card className="p-4 flex flex-col justify-between">
                <div className="flex justify-between items-start mb-2">
                ...
                <div>
                  ...
                  <div className="text-xl font-bold text-white">{100 - risk}%</div>
                </div>
              </Card>
              <Card className="p-4 flex flex-col justify-between">
                <div className="flex justify-between items-start mb-2">
                ...
                <div>
                  ...
                  <div className="text-xl font-bold text-white">+{delay}m</div>
                </div>
              </Card>
              <Card className="p-4 flex flex-col justify-between">
                <div className="flex justify-between items-start mb-2">
                ...
                <div>
                  ...
                  <div className="text-xl font-bold text-white">{99 - delay}%</div>
                </div>
              </Card>
            </div>
          )}
...
fs.writeFileSync('src/pages/RouteIntelligence.tsx', code);
