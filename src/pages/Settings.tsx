  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-20">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-1">Manage application settings and local data state.</p>
      </div>
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <div className="space-y-4">
              <div>
                <label className="text-sm font-medium text-gray-700 dark:text-gray-300 block mb-3">Color Theme</label>
                <div className="grid grid-cols-3 gap-3">
                  <button 
                    onClick={() => updateSettings({theme: 'dark'})}
                    className={`py-3 rounded-lg border flex flex-col items-center justify-center gap-2 transition-colors ${settings.theme === 'dark' ? 'bg-cyan-500/20 border-cyan-500 text-cyan-600 dark:text-cyan-400' : 'bg-gray-50 dark:bg-[#0a0c14] border-gray-300 dark:border-white/10 text-gray-400 hover:border-white/30'}`}
                  >
                  ...
                  <button 
                    ...
                    className={`py-3 rounded-lg border flex flex-col items-center justify-center gap-2 transition-colors ${settings.theme === 'light' ? 'bg-cyan-500/20 border-cyan-500 text-cyan-600 dark:text-cyan-400' : 'bg-gray-50 dark:bg-[#0a0c14] border-gray-300 dark:border-white/10 text-gray-400 hover:border-white/30'}`}
                  >
                  ...
                  <button 
                    ...
                    className={`py-3 rounded-lg border flex flex-col items-center justify-center gap-2 transition-colors ${settings.theme === 'system' ? 'bg-cyan-500/20 border-cyan-500 text-cyan-600 dark:text-cyan-400' : 'bg-gray-50 dark:bg-[#0a0c14] border-gray-300 dark:border-white/10 text-gray-400 hover:border-white/30'}`}
                  >
              ...
              <div className="pt-4 border-t border-gray-200 dark:border-white/5 flex items-center justify-between">
                <div>
                  <div className="font-medium text-gray-900 dark:text-white">Compact Dashboard</div>
          ...
          <Card>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 border-t border-gray-200 dark:border-white/5 flex items-center justify-between">
                <div>
                  <div className="font-medium text-amber-600 dark:text-amber-400 flex items-center gap-2">
              ...
              {settings.offlineMode && pendingSync > 0 && (
                <div className="p-3 bg-amber-500/10 border border-amber-500/30 rounded-lg flex items-center justify-between mt-2">
                  <div className="text-amber-600 dark:text-amber-400 text-sm font-bold">{pendingSync} items pending sync</div>
                  <button onClick={syncOfflineReports} className="px-3 py-1 bg-amber-500 text-gray-900 dark:text-white text-xs font-bold rounded">SYNC NOW</button>
                </div>
              )}
            </div>
          </Card>
          ...
          <Card>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-white/5 border border-gray-300 dark:border-white/10 rounded-lg">
                <div>
                  <div className="font-bold text-gray-900 dark:text-white">Reset Demo Data</div>
                  <div className="text-sm text-gray-400">Restore the original mock dataset.</div>
                </div>
                {showResetConfirm ? (
                  <div className="flex gap-2">
                    <button onClick={() => setShowResetConfirm(false)} className="px-3 py-2 bg-gray-700 hover:bg-gray-600 rounded text-sm text-gray-900 dark:text-white">Cancel</button>
                    <button onClick={() => { resetData(); setShowResetConfirm(false); }} className="px-3 py-2 bg-red-600 hover:bg-red-500 rounded text-sm text-gray-900 dark:text-white font-bold">Confirm Reset</button>
                  </div>
                ) : (
                  <button onClick={() => setShowResetConfirm(true)} className="px-4 py-2 bg-white/10 hover:bg-white/20 text-gray-900 dark:text-white rounded flex items-center gap-2 text-sm transition-colors">
              ...
              <div className="flex items-center justify-between p-4 bg-red-950/20 border border-red-500/20 rounded-lg">
                <div>
                  <div className="font-bold text-red-600 dark:text-red-400">Clear Local Data</div>
                  <div className="text-sm text-gray-400">Delete all stored entries (vehicles, reports, etc.)</div>
                </div>
                {showClearConfirm ? (
                  <div className="flex gap-2">
                    <button onClick={() => setShowClearConfirm(false)} className="px-3 py-2 bg-gray-700 hover:bg-gray-600 rounded text-sm text-gray-900 dark:text-white">Cancel</button>
                    <button onClick={() => { clearLocalData(); setShowClearConfirm(false); }} className="px-3 py-2 bg-red-600 hover:bg-red-500 rounded text-sm text-gray-900 dark:text-white font-bold">Confirm Clear</button>
                  </div>
                ) : (
          ...
          <Card>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-white/5">
                ...
                <span className="text-gray-900 dark:text-white font-mono text-sm">v2.4.0-prototype</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-white/5">
              ...
              <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-white/5">
                ...
                <span className="text-gray-900 dark:text-white flex items-center gap-1 text-sm"><HardDrive className="w-3.5 h-3.5" /> Local</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-white/5">
                <span className="text-gray-400 text-sm">Last Sync</span>
                <span className="text-cyan-600 dark:text-cyan-400 text-sm">Just now</span>
              </div>
            </div>
            
            <div className="mt-6 p-4 bg-cyan-950/30 border border-cyan-500/20 rounded-lg text-xs text-cyan-600 dark:text-cyan-400 leading-relaxed">
