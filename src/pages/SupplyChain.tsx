          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium uppercase tracking-wider whitespace-nowrap transition-colors ${
              activeTab === tab 
                ...
                : 'bg-gray-200 dark:bg-gray-50 dark:bg-[#0a0c14] text-gray-700 dark:text-gray-400 hover:bg-gray-300 dark:hover:bg-white/5 border border-gray-300 dark:border-gray-200 dark:border-white/5'
            }`}
          >
            {tab.replace('_', ' ')}
          </button>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" value={formData.id} onChange={e => setFormData({...formData, id: e.target.value})} disabled={!!editingShipment} className={`w-full bg-gray-50 dark:bg-[#0a0c14] border ${errors.id ? 'border-red-500' : 'border-gray-300 dark:border-white/10'} rounded px-3 py-2 text-gray-900 dark:text-white disabled:opacity-50`} />
            </div>
            <div>
